              ...
              <div className="p-4 border-b">
                ...
                {sessionDetails.blendFile ? (
                  <div>
                    ...
                    {/* Add ability to see other uploaded files if needed */}
                  </div>
                ) : (
              ...
              <div className="p-4 border-b">
                ...
                <div className="flex flex-wrap gap-3">
                  {sessionDetails.status === 'requested' && (
                    <>
                      <button
                        ...
                        disabled={!sessionDetails.blendFile}
                      >
                        Accept Request
                      </button>
                  ...
                  {sessionDetails.status === 'active' && (
                    <>
                      <button
                        ...
                        disabled={renderInProgress || !sessionDetails.blendFile}
                      >
                        {renderInProgress ? 'Rendering...' : 'Run Render'}
                      </button>
                  ...
                  <button
                    ...
                    disabled={!sessionDetails.output || sessionDetails.status === 'requested'}
                  >
                    Download Renders
                  </button>
                </div>
                
                {sessionDetails.status === 'requested' && !sessionDetails.blendFile && (
                  <p className="mt-2 text-yellow-600 text-sm">
                    Waiting for renter to upload blend files before you can accept
                  </p>
                )}
              </div>
